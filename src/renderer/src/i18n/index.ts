...
const zh = {
  ...
  settings: {
    ...
    knowledge: {
      ...
      claudeTokenHint: '在终端运行 claude setup-token（需已安装 Claude Code 并登录订阅账号），把生成的令牌粘贴到上方"订阅令牌"栏。该令牌为你个人订阅凭证，请勿分享给他人。',
      testBtn: '测试连接',
      testing: '测试中...',
      testOk: '连接成功',
...
const en = {
  ...
  settings: {
    ...
    knowledge: {
      ...
      claudeTokenHint: 'Run `claude setup-token` in a terminal (requires Claude Code installed and signed in to your subscription), then paste the generated token into the "Subscription Token" field above. This token is your personal credential -- do not share it.',
