...
const zh = {
  ...
  about: {
    ...
    available: '发现新版本 v{{version}}，正在后台下载，完成后会提示安装',
    devOnly: '仅打包安装版可检查更新（开发模式不适用）',
    checkFailed: '检查失败：{{detail}}',
  },
  toolbar: {
    search: '搜索文献...',
    addItem: '添加条目',
  ...
  knowledge: {
    ...
    traceChars: '{{n}} 字',
    doing: {
      search_library: '正在检索「{{q}}」',
      read_item: '正在读取「{{q}}」',
      read_context: '正在查看上下文',
      get_item_info: '正在查看「{{q}}」',
      list_items: '正在浏览文库',
      list_collections: '正在查看分类',
      list_tags: '正在查看标签',
      read_notes: '正在读取笔记',
      list_notes: '正在浏览笔记',
      create_note: '正在记笔记',
      update_note: '正在修改笔记',
      add_tags: '正在打标签',
      add_to_collection: '正在归档「{{q}}」',
      link_items: '正在建立关联',
      update_metadata: '正在更新元数据',
      set_star: '正在标记重要',
      load_skill: '正在载入技能',
      searching: '正在检索…',
      answering: '正在生成回答…',
...
const en = {
  ...
  about: {
    ...
    available: 'New version v{{version}} found — downloading in the background; you will be prompted to install when ready',
    devOnly: 'Update checks work only in packaged builds (not in dev)',
    checkFailed: 'Check failed: {{detail}}',
  },
  toolbar: {
  ...
  item: {
    ...
    noLocalFile: 'This item has no local file',
  ...
  knowledge: {
    ...
    traceChars: '{{n}} chars',
    doing: {
      search_library: 'Searching “{{q}}”',
      read_item: 'Reading “{{q}}”',
      read_context: 'Reading context',
      get_item_info: 'Looking up “{{q}}”',
      list_items: 'Browsing the library',
      list_collections: 'Listing collections',
      list_tags: 'Listing tags',
      read_notes: 'Reading notes',
      list_notes: 'Browsing notes',
      create_note: 'Writing a note',
      update_note: 'Editing a note',
      add_tags: 'Tagging',
      add_to_collection: 'Filing into “{{q}}”',
      link_items: 'Linking papers',
